...
{
   public function administrator_dash(){
   ...
   public function view_products(Request $request){
      $get_product = Products::select('products.id','products.name','products.description','products.price','products.product_code','products.product_status','products.created_by',
     ...
     // print_r($get_products);die;
      return view('admin.view_product',compact('get_product'));
   }
   ...
   public function product_edit_form(Request $request, $id){
     ...
     return view('admin.edit_product_form', compact('get_product','get_product_images'));
   }
   ...
   public function update_products(Request $request){
     ...
     if($updateData){
      ...
      foreach ($get_count_product_image as $index => $image) {
        ...
        return redirect('/view_products')->with('error', 'Insertion failed.');
     }
   }
   ...
   public function searchProducts(Request $request)
    {
       ...
       // dd($productName);
        ...
        $query =  Products::select('products.id','products.name','products.description','products.price','products.product_code','products.product_status','products.created_by',
        Images::raw('GROUP_CONCAT(images.path) as multi_image')
       )
       ->join('images', 'images.product_id', '=', 'products.id')
       ->groupBy('products.id','products.name','products.description','products.price','products.product_code','products.product_status','products.created_by');
